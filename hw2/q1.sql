...
-- concatenate election result with its party and country, votes and cast e_date to year
...
-- map election to its total vote
...
-- convert votes to the range of votes from results
...
-- convert range of votes to average range per year
...
-- convert yearly range to the section it belongs to
